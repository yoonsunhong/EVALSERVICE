...
<%@ page import="retail.common.SessionAModel" %>
...
/** session Admin 에 저장된 환경정보 반환 */
SessionAModel getAEnv() {
	return CommonUtil.getAEnv(req.getSession());
}
...
<%
String redirectURL = "/admin.do"; // alogin.jsp
if(getAEnv().getAdmin_name() == null){
