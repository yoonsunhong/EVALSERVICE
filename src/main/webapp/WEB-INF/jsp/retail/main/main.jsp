...
<head>
	...
	<script type="text/javascript">		
		$(document).ready(function (){
			// 배경 사이즈 지정
			/* $(".main_bg").height($(".tit_cnt").innerHeight()+$(".user").innerHeight()+$(".main_menu li a > div").innerHeight()*0.5); */
			$(".main_bg").height($("body").height()*0.49);	
		});		
		...
		function userSelect() {	
			window.location = "/goUser.do";
		}
		
		/*
			<!--  <p class="user_pro"><img class="photo3" src="/resources/img/icon/ico_main_man.png" alt="리테일테크"></p> -->
		*/
 ...
 <body class="eval_main">
	...
	<section>		
		<div class="user">
			<p class="user_pro"><img class="photo3" src="<%=getEnv().getUser_pic()%>" alt="리테일테크"></p>
