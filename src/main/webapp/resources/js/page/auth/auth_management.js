...
rMateGridH5.create("grid1", "gridHolder1", jsVars1, "357", "300");
rMateGridH5.create("grid2", "gridHolder2", jsVars2, "600", "220");
rMateGridH5.create("grid3", "gridHolder3", jsVars3, "600", "220");
...
var layoutStr2 =
	...
	<DataGrid id="dg1" sortableColumns="false" selectionMode="multipleRows" textAlign="center" alternatingItemColors="[#ffffff,#f9f9f9]" headerHeight="37" rowHeight="34" verticalAlign="middle" showDataTips="true">\
		<columns>\
			<DataGridSelectorColumn id="selector2" width="40" textAlign="center" backgroundColor="#EDEDF0" allowAllSelection="false" />\
