...
//              "사용여부"
	   	...
	   	colModel:[           
	   	    {name:"USER_NUM",   width:10,  align:"center"}, 
...
//														             }} 
		...
		onSelectRow: function(id) {
			...
			//alert("rowData:" + rowData.USER_NUM);
...
//	    	crudBit = "U";   // 수정
	...
	jQuery("#grid2").jqGrid({ 
        hoverrows: false,
		url:"/getEvalItemUser.do",
	    mtype: "POST",
	    datatype: "json",
	    postData: {'A':'A','A':'A'},
	    colNames:["사원코드","순번","평가항목명","비중",""],
	   	colModel:[  
            {name:"USER_NUM",				width:40,	align:"center", hidden:true},      
	   	    {name:"EVAL_ITEM_NUM",		width:40,	align:"center", key:true}, 
	   		{name:"EVAL_ITEM_NAME",	width:160,	align:"left"},
			{name:"EVAL_RATE",				width:40,	align:"right",
	    ...
	    cellEdit:true,
	    cellsubmit:'remote',
	    cellurl:'/updateCellEvalUserItem.do',
	   	rowList:[10,30,50,100],
	   	pager: '#ajaxProwed1',
	   	//viewrecords: true,
	    cmTemplate: { sortable: false },
		...
		beforeSubmitCell : function(rowid, cellname, value) {   // submit 전
			...
			//alert(data);
			return {"USER_NUM":data.USER_NUM, "EVAL_ITEM_NUM":data.EVAL_ITEM_NUM, "EVAL_RATE":data.EVAL_RATE};
...
//			 $('#D_USER_NUM').val(loData.USER_NUM);
//			 $('#D_EVAL_ITEM_NUM').val(loData.EVAL_ITEM_NUM);
//			 $('#D_EVAL_ITEM_NAME').val(loData.EVAL_ITEM_NAME);
//			 $('#D_EVAL_RATE').val(loData.EVAL_RATE);
//		
...
function btn_search_detail( ){
	...
	grid.jqGrid('setGridParam', {
	    ...
	    mtype: "POST",
	    datatype: "json",
	    postData: {USER_NUM:loData.USER_NUM} , // page:1, 
	}).trigger('reloadGrid');
...
//	var loData = $("#grid1" ).jqGrid('getRowData', rowId);
//	 
//	 if( $('#D_EVAL_RATE').val()  == null || $('#D_EVAL_RATE').val() =="" ){
//			confirm("비중값은 필수 입력항목 입니다.");
//			$('#D_EVAL_RATE').focus();
//			return;
//	 } 
//
...
//		 
//		jQuery.ajax({ 
//		    url:"/updateEvalRateUser.do",         
//		    type:"POST",
//			datatype:"json",
//			async:false,
//			data: {     
//				  USER_NUM               : $('#D_USER_NUM').val()
//				, EVAL_ITEM_NUM       : $('#D_EVAL_ITEM_NUM').val()
//				, EVAL_ITEM_NAME     : $('#D_EVAL_ITEM_NAME').val()
//				, EVAL_RATE              : $('#D_EVAL_RATE').val()
//			},
//			beforeSend : function(xhr) {} ,
//			success:function(data,textStatus){  
//				btn_search_detail();
...
//
//
//function btn_new_detail() {   // 일괄등록
//	
//	var rowId = $("#grid1").jqGrid('getGridParam', 'selrow');  
//	var loData = $("#grid1" ).jqGrid('getRowData', rowId);	
//	
//	if ( typeof loData.USER_NUM  == 'undefined')
//	{
//		alert('왼쪽 그리드에서 사원을 선택하세요.');
//		return;
//	}  	
//	
//	jQuery.ajax({ 
//	    url:"/insertEvalUser.do",         
//	    type:"POST",  
//		datatype:"json",
//		data: {
//			USER_NUM  : loData.USER_NUM
//		},
//		beforeSend : function(xhr) {} ,
//		success:function(data,textStatus){  
//			btn_search();
//			alert('평가항목을 일괄 등록 하였습니다.');
//	    },
//	    complete : function(data) {
//	    },
//	    error : function(xhr, status, error) {
...
//{
//	
//	if(confirm("해당평가 항목을  삭제  하시겠습니까?") == false) return;
//	
...
//	
//     jQuery.ajax({ 
//	    url:"/deleteEvalItemUser.do",         
//	    type:"POST",
//		datatype:"json",
//		data:  {USER_NUM:loData.USER_NUM , EVAL_ITEM_NUM:loData.EVAL_ITEM_NUM},
//		beforeSend : function(xhr) {} ,
//		success:function(data,textStatus){ 
//			btn_search_detail();
//	    },
